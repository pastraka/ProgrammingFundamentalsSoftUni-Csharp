...
namespace bookLibrary
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Dictionary<string, decimal> sortedAuthor = authors.OrderByDescending(a => a.Value).ThenBy(a => a.Key).ToDictionary(x => x.Key, x => x.Value);

            foreach (var author in sortedAuthor)
            {
